package com.cus.jastip.master;

import com.cus.jastip.master.client.OAuth2InterceptedFeignConfiguration;
import com.cus.jastip.master.config.ApplicationProperties;
import com.cus.jastip.master.config.DefaultProfileUtil;
...
public class MasterApp {
    ...
    public MasterApp(Environment env) {
        this.env = env;
    }

    /**
     * Initializes MasterApp.
     * <p>
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(MasterApp.class);
