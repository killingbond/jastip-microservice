...
public class WalletResource {
    ...
    public ResponseEntity<Wallet> createWallet(@Valid @RequestBody Wallet wallet) throws URISyntaxException {
        ...
        walletAuditService.addWallet(result, ENTITY_NAME, UpdateType.CREATE);
    ...
    public ResponseEntity<Wallet> updateWallet(@Valid @RequestBody Wallet wallet) throws URISyntaxException {
        ...
        Wallet result = walletRepository.save(wallet);
        walletSearchRepository.save(result);
        walletAuditService.addWallet(result, ENTITY_NAME, UpdateType.UPDATE);
    ...
    public ResponseEntity<Void> deleteWallet(@PathVariable Long id) {
        ...
        Wallet result = walletRepository.findOne(id);
        walletRepository.delete(id);
        walletSearchRepository.delete(id);
		walletAuditService.addWallet(result, ENTITY_NAME, UpdateType.DELETE);
    ...
    public ResponseEntity<List<Wallet>> searchWallets(@RequestParam String query, Pageable pageable) {
        ...
        Page<Wallet> page = walletSearchRepository.search(queryStringQuery(query), pageable);
